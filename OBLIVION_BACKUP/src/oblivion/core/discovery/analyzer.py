...
from typing import Optional, Dict, List, Any, Tuple, DefaultDict
...
class TargetAnalyzer:
    def __init__(self, validator: Optional[SafePathValidator] = None):
    ...
    def _collect_metadata(self, p: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            metadata["accessed_at"] = datetime.fromtimestamp(stat.st_atime, tz=timezone.utc).isoformat()
